...
async function main() {
    try {
        const {
            ...
            TIGER_PERMISSION_DATASOURCE_PASSWORD,
        ...
        const specFilesFilter = FILTER ? { specFilesFilter: FILTER } : {};
        const isVisualMode = VISUAL_MODE === "true";
        const visualModeFilter = FILTER && isVisualMode ? `,testFiles=**/${FILTER}` : "";
        ...
        const cypressProcess = runCypress({
            ...
            tigerPermissionDatasourcePassword: TIGER_PERMISSION_DATASOURCE_PASSWORD,
